...
namespace BulkyBookWeb.Migrations
{
    ...
    [Migration("20240831081325_addShoppingCartToDb")]
            ...
            modelBuilder.Entity("BulkyBook.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDateTime = new DateTime(2024, 8, 31, 13, 43, 24, 388, DateTimeKind.Local).AddTicks(5143),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            ID = 2,
                            CreatedDateTime = new DateTime(2024, 8, 31, 13, 43, 24, 388, DateTimeKind.Local).AddTicks(5159),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            ID = 3,
                            CreatedDateTime = new DateTime(2024, 8, 31, 13, 43, 24, 388, DateTimeKind.Local).AddTicks(5160),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
