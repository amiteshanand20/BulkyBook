...
namespace BulkyBookWeb.Migrations
{
    ...
    [Migration("20240915155503_AddOrderHeaderAndOrderDetailToDB")]
            ...
            modelBuilder.Entity("BulkyBook.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDateTime = new DateTime(2024, 9, 15, 21, 25, 1, 951, DateTimeKind.Local).AddTicks(6696),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            ID = 2,
                            CreatedDateTime = new DateTime(2024, 9, 15, 21, 25, 1, 951, DateTimeKind.Local).AddTicks(6709),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            ID = 3,
                            CreatedDateTime = new DateTime(2024, 9, 15, 21, 25, 1, 951, DateTimeKind.Local).AddTicks(6710),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
